...
<head>
	...
	<title><?php echo $TITLE; ?> - Administrator Dashboard </title>
							...
							<li>
								<div class="streamline message-nicescroll-bar">
									...
									<div class="sl-item">
										<a href="javascript:void(0)">
											<div class="sl-avatar">
												<img class="img-responsive" src="<?php echo $BASE_URL; ?>img/avatar.jpg" alt="avatar"/>
											</div>
											<div class="sl-content">
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<div class="user-profile text-center">
							...
							<a href="#" class="dropdown-toggle pr-0 bg-transparent" data-toggle="dropdown">Administrator <span class="caret"></span></a>
							<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
								<li>
									<a href="profile.html"><i class="zmdi zmdi-account"></i><span>Profile</span></a>
								</li>
								...
								<li>
									<a href="#"><i class="zmdi zmdi-settings"></i><span>Edit Profile</span></a>
								</li>
								<li class="divider"></li>
								<li class="sub-menu show-on-hover">
									<a href="#" class="dropdown-toggle pr-0 level-2-drp"><i class="zmdi zmdi-check text-success"></i> online</a>
									<ul class="dropdown-menu open-left-side">
										<li>
											<a href="#"><i class="zmdi zmdi-check text-success"></i><span>online</span></a>
										</li>
										<li>
											<a href="#"><i class="zmdi zmdi-circle-o text-warning"></i><span>busy</span></a>
										</li>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#mem_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Manage Users</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="mem_dr" class="collapse collapse-level-1">
						<li>
							<a href="#">Merchants</a>
						</li>
						<li>
							<a href="#">Buyers/Clients</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#cat_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Add New Category</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
				...
				<li>
					<a href="widgets.html"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">widgets</span></div><div class="clearfix"></div></a>
				</li>
				<li><hr class="light-grey-hr mb-10"/></li>
				<li>
					<a href="#"><i class="zmdi zmdi-power mr-20"></i><span class="right-nav-text">Log Out</span></a>
				</li>
									...
									<div class="set-height-wrap">
										<div class="streamline message-box nicescroll-bar">
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="<?php echo $BASE_URL; ?>img/user.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="<?php echo $BASE_URL; ?>img/user1.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="<?php echo $BASE_URL; ?>img/user2.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="<?php echo $BASE_URL; ?>img/user3.png" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="<?php echo $BASE_URL; ?>img/user4.png" alt="avatar"/>
													</div>
													<div class="sl-content">
