	...
	<ul class="nav navbar-nav side-nav nicescroll-bar">
			...
			<li>
				<div class="user-profile text-center">
					...
					<div class="dropdown mt-5">
						<a href="#" class="dropdown-toggle pr-0 bg-transparent" data-toggle="dropdown">Hi, <?php echo $user->firstname; ?> <span class="caret"></span></a>
		...
		<li>
			...
			<ul id="mem_dr" class="collapse collapse-level-1">
				...
				<li>
					<a href="">Business Gallery/Portfolio</a>
				</li>
			</ul>
		</li>
		<li>
